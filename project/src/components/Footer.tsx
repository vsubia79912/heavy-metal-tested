          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li>
                  <a href="#contact" className="text-blue-100 hover:text-teal-300 transition-colors">Contact</a>
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li>
                  <a href="#" className="text-blue-100 hover:text-teal-300 transition-colors">Blog</a>
                </li>
              </ul>
            </div>
